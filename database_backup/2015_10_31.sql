...
INSERT INTO `koablog_permission` VALUES (1,'addUser','add a user'),(2,'deleteUser','delete a user'),(3,'updateUser','update a user'),(4,'lookUser','look a user'),(5,'addArticle','add a article'),(6,'deleteArticle','delete a article , Whoever\'s article'),(7,'updateArticle','update a article , Whoever\'s article'),(8,'lookArticle','look a article , Whoever\'s article'),(9,'addTag','add a tag'),(10,'deleteTag','Generally , you\'re not going to delete a tag'),(11,'updateTag','Generally , you\'re not going to update a tag'),(12,'lookTag','always do it'),(13,'deleteSelfArticle','author can delete their own article'),(14,'updateSelfArticle','author can update their own article');
...
-- Dump completed on 2015-10-31 22:46:48
