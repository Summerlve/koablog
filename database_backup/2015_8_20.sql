...
--
-- Table structure for table `koablog_group_to_user`
--

DROP TABLE IF EXISTS `koablog_group_to_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `koablog_group_to_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `koablog_group_to_user`
--

LOCK TABLES `koablog_group_to_user` WRITE;
/*!40000 ALTER TABLE `koablog_group_to_user` DISABLE KEYS */;
INSERT INTO `koablog_group_to_user` VALUES (1,1,3),(2,3,1);
/*!40000 ALTER TABLE `koablog_group_to_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-08-20 22:40:47
